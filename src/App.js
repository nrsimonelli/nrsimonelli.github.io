          ...
          <div className="layer-two" id="layer-two">
            ...
            <div className="x project-card">
              <div className="theme project-image">
                <div className="solo-text title">
                  <a href="https://dark-magic.herokuapp.com" target="blank">
                    Dynamic Themes
                  </a>
                </div>
              </div>
            ...
            <div className="x project-card">
              <div className="scythe project-image">
                <div className="solo-text title">
                  <a href="https://scythe-bidder.herokuapp.com/" target="blank">
                    Scythe Bidder
                  </a>
                </div>
              </div>
          ...
          <div className="layer-two" id="layer-two">
            ...
            <div className="box">
              <div className="three text game">
                <div className="card card-info">
                  <a href="https://belovedpacifist.com/" target="blank">
            ...
            <div className="box">
              <div className="three text ulti">
                <div className="card card-info">
                  <a href="https://www.subzeroultimate.com/" target="blank">
                    Ultimate
                  </a>
                </div>
              </div>
